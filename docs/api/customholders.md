...
Returns the list of Inventory [Custom Holders](https://help.aroflo.com/display/office/Custom+Holders).
...
| Field | Value |
| --- | --- |
| customholderid | AroFlo ID |
| archived | BOOLEAN |
| customholdername | STRING |
...
### GET Get CustomHolders

`GET https://api.aroflo.com/{{urlVarString}}`

Return the first page of active inventory custom holders. We do this by filtering on archived:false
