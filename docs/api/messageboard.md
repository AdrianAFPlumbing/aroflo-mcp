...
This zone allows listing [Message Board](https://help.aroflo.com/display/office/Home) notes for your AroFlo site.
...
### GET Get MessageBoard

`GET https://api.aroflo.com/{{urlVarString}}`

Return the first page of messageboard entries.
