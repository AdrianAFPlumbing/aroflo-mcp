...
This zone allows listing [stages](https://help.aroflo.com/x/HY45Bg) data from your AroFlo site.
...
AND Start_date > DATEADD(d, -30, GETUTCDATE())
...
Returns the first page of `Stages` for your AroFlo site.
...
if (requestType == 'GET') {
    var urlVarString = [
        'zone=' + encodeURIComponent('stages')
        ,'where=' + encodeURIComponent('and|projectid|=|JCYqWyFQUCAgCg==')
        ,'page=' + encodeURIComponent('1')
