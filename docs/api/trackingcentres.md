...
This zone allows retrieving [Tracking Centres](https://help.aroflo.com/en_AU/office-tracking-centres-overview) from your AroFlo site.

## WHERE filters

| Field | Value |
| --- | --- |
| trackingcentreid | AroFlo ID |
| name | STRING |
...
if (requestType == 'GET') {
    var urlVarString = [
         'zone=' + encodeURIComponent('TrackingCentres')
