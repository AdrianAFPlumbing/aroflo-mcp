...
Retrieve [Transaction Terms](https://help.aroflo.com/display/SiteAdmin/Transaction+Terms) for your AroFlo site.
This zone is Read Only.
...
### GET Get TransactionTerms

`GET https://api.aroflo.com/{{urlVarString}}`

Return the first page of TransationTerms
